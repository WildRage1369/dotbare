...
active_text_color="#fb4934"
active_underline="true"
active_underline_color="#fb4934"
inactive_text_color="#b8bb26"
inactive_underline="false"
inactive_underline_color="#b8bb26"
separator="·"
...
ignore_windows="polybar:rofi:dunst" # :-separated list of windows we want to ignore (bars, desktop managers, etc.)
