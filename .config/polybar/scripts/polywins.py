...
hide_unpopulated_desktops = True
iconize = True
hide_name = True  # Controls whether to hide window names when an icon is present

# Custom color options, default is None
active_text_color_opt = "#fb4934"
active_underline_opt = "#fb4934" 
inactive_text_color_opt = "#928374"
inactive_underline_opt = "282828"
wps_separator_color = "#b8bb26" # custom color for wps_separator, default is ""

polybar_font_num = "6" # Polybar font number to use for the icons, default is "-" for default font
